...
function updateReadme() {
  ...
  if (startIndex !== -1 && endIndex !== -1) {
    const beforeFeatures = content.substring(
      0,
...
- **CSV Export/Import** - Backup your work`;
    ...
    console.log(
      "✅ README.md updated with current keyboard shortcuts from config",
    );
  } else {
    console.log(
      "ℹ️  README.md structure has changed - manual update may be needed",
    );
  }
}
