...
const ModalStyles = {
  ...
  buttonRow: 'display: flex; justify-content: flex-end; gap: 10px; margin-top: 15px;',
  ...
  darkSecondaryButton: 'border: 1px solid #404040; background: #3c3c3c; color: #cccccc;',
  
  instruction: 'margin: 0 0 10px 0; color: #666; font-family: Arial, sans-serif;',
  statusDiv: `
...
const ModalUtils = {
  ...
  createButton(text, type = 'secondary', isDark = false) {
    ...
    switch (type) {
      case 'primary': buttonStyles += ModalStyles.primaryButton; break;
      case 'success': buttonStyles += ModalStyles.successButton; break;
      default: buttonStyles += isDark ? ModalStyles.darkSecondaryButton : ModalStyles.secondaryButton;
    }
