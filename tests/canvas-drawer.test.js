...
describe('VideoAnnotationDrawer', () => {
  ...
  beforeEach(() => {
    ...
    vi.spyOn(VideoAnnotationDrawer.prototype, 'setupRenderers').mockImplementation(function() {
      this.renderers = new Map();
      // Add mock renderers
      this.renderers.set('detection', { getType: () => 'detection', render: vi.fn() });
      this.renderers.set('text', { getType: () => 'text', render: vi.fn() });
      this.renderers.set('graph', { getType: () => 'graph', render: vi.fn() });
      this.renderers.set('trajectory', { getType: () => 'trajectory', render: vi.fn() });
    });
  ...
  describe('constructor', () => {
    test('should initialize with default options', () => {
      drawer = new VideoAnnotationDrawer(mockVideoElement);
    ...
    test('should merge custom options', () => {
      ...
      drawer = new VideoAnnotationDrawer(mockVideoElement, customOptions);
    ...
    test('should create canvas element', () => {
      ...
      expect(mockVideoElement.parentElement.appendChild).toHaveBeenCalledWith(mockCanvas);
    });
    ...
    test('should setup event listeners', () => {
      ...
      expect(mockVideoElement.addEventListener).toHaveBeenCalledWith('loadedmetadata', expect.any(Function));
  ...
  describe('loadAnnotations', () => {
    ...
    test('should load valid annotation data', () => {
      ...
      const result = drawer.loadAnnotations(annotationData);
    ...
    test('should reject invalid annotation data', () => {
      const invalidData = { invalid: 'data' };
      
      const result = drawer.loadAnnotations(invalidData);
    ...
    test('should handle null data', () => {
      const result = drawer.loadAnnotations(null);
  ...
  describe('addAnnotation', () => {
    ...
    test('should add valid annotation', () => {
      ...
      expect(drawer.annotations).toHaveLength(1);
      expect(drawer.annotations[0]).toBe(annotation);
    });
    ...
    test('should throw error for annotation without id', () => {
      ...
      expect(() => {
        drawer.addAnnotation(annotation);
      }).toThrow('Annotation must have type and id');
    });
