...
import { ModalManager, SettingsModal } from '../src/managers/modal-manager.js';
...
vi.mock('../src/managers/settings.js', () => ({
  SettingsManager: {
    getSettings: vi.fn(() => ({
...
describe('SettingsModal', () => {
  ...
  describe('saveSettings', () => {
    it('should save settings and show success notification', () => {
      const { SettingsManager } = require('../src/managers/settings.js');
      const { UIManager } = require('../src/managers/ui-manager.js');
